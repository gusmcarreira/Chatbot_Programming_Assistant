...
def search_in_documents(search_string):
    ...
    with ix.searcher() as searcher:
        ...
        #results.fragmenter = highlight.SentenceFragmenter(sentencechars="!")
        # Characters after the matching
        #results.fragmenter.surround = 50

        #results.order = highlight.SCORE
        #print(results[0].highlights("content"))

        # Remove the html tags of the match terms
        #cleantext = BeautifulSoup(results[0].highlights("content", top=1), "lxml").text
        #print(cleantext)
